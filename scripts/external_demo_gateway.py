...
def main() -> None:
    ...
    print(f"GET  {base}/v1/reference-profile/interactions/restaurant/reserve")
    print(f"GET  {base}/v1/reference-profile/interactions/shopping/submit_order")
    print(f"POST {base}/v1/demo/restaurant/preflight")
    print(f"POST {base}/v1/demo/restaurant/invoke")
    print(f"POST {base}/v1/demo/shopping/preflight")
    print(f"POST {base}/v1/demo/shopping/invoke")
    print("GET  /health")
